...
-- §@    ªÌ:jessica Chang
-- ¤é    ´Á:087/02/03
-- ³B²z·§­n:º¡´Á µ¹¥I©ú²Ó¦C¦L(©ú²Óªí,±±¨î³øªí)
-- table   :pscb,pscp
-- inp para:¦C¦L¤é
-- return ªº°Ñ¼Æ:
-- ­«­n¨ç¦¡:
...
GLOBALS "../def/common.4gl"   --¤W½u«á¶}±Ò
...
DATABASE life
   ...
   DEFINE p_rpt_code_1     CHAR(8) -- µ¹¥I©ú²Óªí¥N½X     --
   DEFINE p_rpt_code_2     CHAR(8) -- ¥Í¦s±±¨î³øªí¥N½X   --
   DEFINE p_rpt_code_3     CHAR(8) -- º¡´Á¤j©v±¾¸¹       --
   DEFINE p_rpt_code_4     CHAR(8) -- º¡´Á±±¨î³øªí¥N½X_©µ¿ð¹q¶× --
   DEFINE p_rpt_code_5     CHAR(8) -- º¡´Á±±¨î³øªí¥N½X_©µ¿ð¹q¶× A4 --
   ...
   DEFINE p_rpt_name_1     CHAR(40) -- µ¹¥I©ú²Óªí©ïÀY --
         ,p_rpt_name_2     CHAR(40) -- ¥Í¦s±±¨îªí©ïÀY --
         ,p_rpt_name_3     CHAR(40) -- º¡´Á¤j©v±¾¸¹   --
         ,p_rpt_name_4     CHAR(40) -- º¡´Á±±¨îªí©ïÀY_©µ¿ð¹q¶× --
         ,p_rpt_name_5     CHAR(40) -- º¡´Á±±¨îªí©ïÀY_©µ¿ð¹q¶× A4 --
...
FUNCTION psc03r01 ()
    ...
    DEFINE f_rpt_name_1       CHAR(30)   -- º¡´Áµ¹¥I©ú²Ó³øªí   --
    DEFINE f_rpt_name_2       CHAR(30)   -- º¡´Áµ¹¥I±±¨î³øªí   --
    DEFINE f_rpt_name_3       CHAR(30)   -- º¡´Áµ¹¥I¤j©v±¾¸¹   --
    DEFINE f_rpt_name_4       CHAR(30)   -- º¡´Áµ¹¥I©µ¿ð¹q¶×   --
    DEFINE f_rpt_name_5       CHAR(30)   -- º¡´Áµ¹¥I©µ¿ð¹q¶× A4 --
    ...
    DEFINE f_dept_code         LIKE agnt.dept_code       -- Àç·~³B¥N¸¹  --
          ...
          ,f_dept_belong_name  LIKE dept.dept_name       -- ¤À¤½¥q  --
    ...
    DEFINE f_note_recv_name     LIKE clnt.names   -- ©ú²Ó¦¬¥óªÌ --
          ...
          ,f_function_code      VARCHAR(10)   -- ·íµ§¸ê®Æ¥²¶·¶i¤J¯S®í¹q¶× --
                                              -- ¦]À³º¡´Á¥D°Ê¹q¶×»Ý¨D¡A§ó§ï¬°VARCHAR(10)
    ...
    LET f_rpt_name_2    ="psc03r02.lst"
{
 ...
 -- LET f_rpt_name_3    =ReportName(p_rpt_code_3)
    ...
    LET f_rpt_name_6    = "psc03r06.lst"      ---¤j©v±¾¸¹»Ý¨D by yirong 95/01
...
--    LET f_rpt_name_5    ="psc03r05.lst"
    ...
    UNION
            SELECT a.change_date
                  ...
                  ,0                          -- div_int_balance                   
                  ,0                          -- div_int                           
                  ,d.cp_pay_amt               -- ¸Ó¤ë¹w­pµ¹¥Iª÷ÃB                  
                  ,b.cp_chk_date 
                  ," "                        -- rtn_rece_no 
                  ,d.cp_pay_amt               -- ¸Ó¤ë¹ê»Úµ¹¥Iª÷ÃB                  
                  ,a.cp_disb_type
                  ,a.mail_addr_ind
                  ,b.dept_code
                  ,b.agent_code
       ...
       IF f_expired_sw="Y" THEN
          ...
          CASE
              ...
              WHEN p_cp_pay_detail.cp_disb_type="5"   -- ¥D°Ê¹q¶× --
                  ...
                  IF f_R3_min_date < p_cp_pay_detail.process_date THEN
                     LET f_function_code="R8-¥D°Ê"          
                  ELSE
                     LET f_function_code="R7-¥D°Ê"
                  END IF
 ...
 DECLARE pscu_cur_2 CURSOR FOR
      ...
      ELSE
         IF f_function_code = 'R7' THEN
            IF p_cp_pay_detail.cp_pay_amt < 1000000 THEN
               LET f_fn_code_desc = 'R7<100¸U'
            ELSE
               LET f_fn_code_desc = 'R7>=100¸U'
            END IF
            LET f_sub_stat = 'S2'
         ELSE
            IF f_function_code = 'R7-¥D°Ê' THEN
               IF p_cp_pay_detail.cp_pay_amt < 1000000 THEN
                  LET f_fn_code_desc = 'R7-¥D°Ê<100¸U'
               ELSE
                  LET f_fn_code_desc = 'R7-¥D°Ê>=100¸U'
               END IF
               LET f_sub_stat = 'S3'
            ELSE
               IF f_function_code = 'R8' THEN
                  IF p_cp_pay_detail.cp_pay_amt < 1000000 THEN
                     LET f_fn_code_desc = 'R8<100¸U'
                  ELSE
                     LET f_fn_code_desc = 'R8>=100¸U'
                  END IF
                  LET f_sub_stat = 'S4'
               ELSE
                  IF f_function_code = 'R8-¥D°Ê' THEN
                     IF p_cp_pay_detail.cp_pay_amt < 1000000 THEN
                        LET f_fn_code_desc = 'R8-¥D°Ê<100¸U'
                     ELSE
                        LET f_fn_code_desc = 'R8-¥D°Ê>=100¸U'
                     END IF
                     LET f_sub_stat = 'S5'
     ...
     ELSE
       ...
       display 'policy_no=', p_cp_pay_detail.policy_no, ' applicant_id=', f_applicant_id, ' addr_ind=', f_polf_mail_addr_ind, ' pmia=', f_pmia_sw
          IF f_ebill_ind = "1" AND f_pmia_sw = "Y" THEN
         --    display 'address_R[JK8]¤£¶l±H1=', f_address, ' pmia_y=', f_pmia_sw
          ELSE
         ...
         --   display 'addressR[JK8]­n¶l±H1=', f_address, ' pmia_n=', f_pmia_sw
          END IF
       ...
       display 'policy_no=', p_cp_pay_detail.policy_no, ' applicant_id=', f_applicant_id, ' addr_ind=', f_polf_mail_addr_ind, ' pmia=', f_pmia_sw
          -- ©µ¿ð¹q¶×-º¡´Áª÷ªºµ¹¥I©ú²Óªí --
          IF f_ebill_ind = "1" AND f_pmia_sw = "Y" THEN
            -- display 'address_R8¤£¶l±H5=', f_address, ' pmia_y=', f_pmia_sw
          ELSE
           ...
           --    display 'address_R8­n¶l±H5=', f_address, ' pmia_y=', f_pmia_sw
          END IF

          -- ©µ¿ð¹q¶×-º¡´Áª÷ªºµ¹¥I±±¨îªí --
             IF p_cp_pay_detail.cp_pay_amt < 1000000 THEN
...
--                    ASCII 27,"90033",ASCII 27,"80060"
        ...
        ON EVERY ROW
           ...
           --  º¡´Á µ¹¥I©ú²Ó°ò¥»¸ê®Æ¦C¦L p_payform_0 --
...
END REPORT -- cp_pay_dtl_un ¥Í¦s/º¡´Áµ¹¥I³øªí  --
-------------------------------------------------------------------------------
-- ³øªí¦WºÙ:cp_pay_dtl_col
-- §@    ªÌ:jessica Chang
-- ¤é    ´Á:087/02/03
-- ³B²z·§­n:º¡´Áµ¹¥I©ú²Ó±±¨îªí¦C¦L
-- table   :pscr
-- inp para:¦C¦L¤é
-- return ªº°Ñ¼Æ:
-- ­«­n¨ç¦¡:
...
--           ,r_function_code       CHAR(2)
    ...
    FORMAT
      ...
      --    LET g_report_name="º¡´Áµ¹¥I©ú²Ó±±¨î³øªí"
...
--                                      +p_cp_pay_detail.cp_pay_amt
                 ...
                 FOR r_i=1 TO r_pscd_cnt
                     IF p_pscd_r[r_i].cp_real_payamt !=0 THEN
                        ...
                        PRINT COLUMN   14,p_pscd_r[r_i].names[1,20]    , -- ¨ü¯q¤H --
                              ...
                              COLUMN   76,p_pscd_r[r_i].remit_account  , -- ±b¸¹     --
                              COLUMN  110,p_pscd_r[r_i].disb_no          -- ¥I´Ú¸¹½X --
                     END IF
                 END FOR
              END IF
              PRINT COLUMN   1," "
        ...
        AFTER GROUP OF r_cp_disb_type
           PRINT COLUMN  24,"À³¥I­È:"   ,r_total_payamt USING "#,###,###,##&"," ¤¸",
                 COLUMN  50,"(+)·¸Ãº:"  ,r_total_supprem USING "#,###,###,##&"," ¤¸",
                 COLUMN  77,"(+)¬õ§Q:"  ,r_total_divamt USING "#,###,###,##&"," ¤¸"

           PRINT COLUMN  21,"(-)¶U  ´Ú:",r_total_loanamt USING "#,###,###,##&"," ¤¸",
           ...
           PRINT COLUMN  22,r_acct_no,":",r_28250019_cnt USING "###,##&",
                            "¥ó",
                 COLUMN  49,"¦X­pª÷ÃB:",r_28250019_amt USING "#,###,###,##&"," ¤¸"
           PRINT COLUMN  22,"11780300:",r_11780300_cnt USING "###,##&","¥ó",
                 COLUMN  49,"¦X­pª÷ÃB:",r_11780300_amt USING "#,###,###,##&"," ¤¸"
           SKIP  2 LINE
...
END REPORT -- cp_pay_dtl_col º¡´Áª÷µ¹¥I±±¨î³øªí --
...
-- §@    ªÌ:jessica Chang
-- ¤é    ´Á:087/02/03
-- ³B²z·§­n:º¡´Á/ÁÙ¥»µ¹¥I©ú²Ó¤j©v±¾¸¹¨ç¦C¦L
-- table   :pscr
-- inp para:¦C¦L¤é
-- return ªº°Ñ¼Æ:
-- ­«­n¨ç¦¡:
...
REPORT cp_pay_post     (r_cp_pay_form_type -- µ¹¥I®æ¦¡ --
    ...
    FORMAT
       ...
       PAGE HEADER
            ...
            LET r_payform_var[ 8,20]=r_disb_desc,"-º¡´Á"
...
LET p_payform_1[2] ="     ¬ù©w¡Aµ¹¥I¥Í¦s«OÀIª÷¦p¤U¡G                                                     "
LET p_payform_1[3] =p_payform_init
LET p_payform_1[4] ="                    ¥Í¦s«OÀIª÷                   xxx,xxx,xxx ¤¸                     "
...
LET p_payform_1[10]="                      xxxxxxxx                   xxx,xxx,xxx ¤¸                     "
...
LET p_payform_e[3] ="      ÁÙ´Ú¦¬¾Ú¡Gxxxxxxxxx                                                           "
                     ...
                     IF p_pscd_r[r_i].cp_real_payamt !=0 THEN
                        ...
                        PRINT COLUMN   14,p_pscd_r[r_i].names[1,20]    , -- ¨ü¯q
                              ...
                              COLUMN   68,p_pscd_r[r_i].remit_bank
                                         ,p_pscd_r[r_i].remit_branch   , -- »È¦æ
                              COLUMN   76,p_pscd_r[r_i].remit_account  , -- ±b¸¹
                              COLUMN   94,p_pscd_r[r_i].disb_no          -- ¥I´Ú
                     END IF
                 END FOR
              END IF
              PRINT COLUMN   1," "
                     ...
                     IF p_pscd_r[r_i].cp_real_payamt !=0 THEN
                        ...
                        PRINT COLUMN   14,p_pscd_r[r_i].names[1,20]    , -- ¨ü¯q
                              ...
                              COLUMN   68,p_pscd_r[r_i].remit_bank
                                         ,p_pscd_r[r_i].remit_branch   , -- »È¦æ
                              COLUMN   76,p_pscd_r[r_i].remit_account  , -- ±b¸¹
                              COLUMN  110,p_pscd_r[r_i].disb_no          -- ¥I´Ú
                     END IF
                 END FOR
              END IF
              PRINT COLUMN   1," "
...
PAGE HEADER                                                                                      
   PRINT                                                                                         
   LET  corp_name = "¤T  °Ó  ¬ü  ¨¹  ¤H  ¹Ø  «O  ÀI  ªÑ  ¥÷  ¦³  ­­  ¤½  ¥q"                     
   PRINT COLUMN CenterPosition( corp_name, 120 ), corp_name CLIPPED                              
   LET  rpt_name = "º¡ ´Á «O ÀI ª÷ ¹ï ±b ©ú ²Ó ³ø ªí"
...
PAGE HEADER
   ...
   PRINT ""
   LET r_rpt_name = "º¡ ´Á ¹ï ±b ²Î ­p ³ø ªí"
